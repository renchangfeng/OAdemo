...
var demoData = {
	...
	privilegeList: [
		{ "priv.name": "用户管理", "priv.description": "管理系统用户信息", "priv.url":"userManager", "priv.parent":"系统管理", "priv.level":"2", "priv.isPublic":"否", "priv.isLeaf":"否"},
		{ "priv.name": "添加用户", "priv.description": "添加用户信息", "priv.url":"addUser", "priv.parent":"用户管理", "priv.level":"3", "priv.isPublic":"否", "priv.isLeaf":"否"},
		{ "priv.name": "修改用户", "priv.description": "修改用户信息", "priv.url":"updateUser", "priv.parent":"用户管理", "priv.level":"3", "priv.isPublic":"否", "priv.isLeaf":"否"},
		{ "priv.name": "删除用户", "priv.description": "删除用户信息", "priv.url":"delUser", "priv.parent":"用户管理", "priv.level":"3", "priv.isPublic":"否", "priv.isLeaf":"否"},
		{ "priv.name": "查看用户", "priv.description": "查看用户信息", "priv.url":"viewUser", "priv.parent":"用户管理", "priv.level":"3", "priv.isPublic":"否", "priv.isLeaf":"否"},
