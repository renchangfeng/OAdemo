  ...
  <body>
		...
		<div id="Title_bar">
		    <div id="Title_bar_Head">
		        ...
		        <div id="Title"><!--页面标题-->
		            <img border="0" width="13" height="13" src="style/images/title_arrow.gif"/> 修改部门信息
		        </div>
		...
		<!--显示表单内容-->
		<div id=MainArea>
		    <form action="updateDeptInfo.action" method="post">
		        ...
		        <div class="ItemBlockBorder">
		            <div class="ItemBlock">
		                <table cellpadding="0" cellspacing="0" class="mainForm">
                            ...
                            <tr><td>部门名称</td>
                                     <td><input type="text" id="deptName" value="${deptInfo.dname}" name="dname" class="InputStyle"/> *</td>
                            </tr>
		                    <tr><td>职能说明</td>
                                    <td><textarea name="memo" id="deptMemo" class="TextareaStyle">${deptInfo.memo}</textarea></td>
		                    </tr>
		                     <tr><td>部门层级</td>
		                            <td><input type="text" id="deptLevel" value="${deptInfo.level}" name="level" class="InputStyle"/></td>
		                    </tr>
		                </table>
		            </div>
		        </div> 
