...
<body> 
		...
		<!--显示表单内容-->
		<div id="MainArea">
		    <form action="updateRoleInfo.action" method="post" onsubmit="return formGet();">
		            ...
		            <div class="ItemBlock">
		                <table cellpadding="0" cellspacing="0" class="mainForm">
		                    <tr>
		                        ...
		                        <td><input type="text" id="rname" name="rname" class="InputStyle" value="${roleInfo.rname}"/> *</td>
		                    </tr>
		                    <tr>
		                        <td>角色说明</td>
		                        <td><textarea id="rmemo" name="rmemo" class="TextareaStyle">${roleInfo.rmemo}</textarea></td>
		                    </tr>
		                </table>
		            </div>
		        </div>
